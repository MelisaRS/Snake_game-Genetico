...
n_x = 7 # no. de neuronas para la capa de entrada
n_h = 9 # no. de capas ocultas par a la 1er capa oculta
n_h2 = 15 # no. de capas ocultas par a la 2da capa oculta
n_y = 3 # no. de neuronas para la capa de salida
W1_shape = (9,7)
W2_shape = (15,9)
W3_shape = (3,15)
